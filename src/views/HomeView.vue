      ...
      <main class="flex-1 overflow-y-auto bg-[#060716] p-6 space-y-6" style="scrollbar-gutter: stable;">
        ...
        <template v-if="videoFeedList.length > 0">
          <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div
              class="gap- xl:col-span-2 bg-black rounded-xl overflow-hidden aspect-video relative group border border-gray-900 flex flex-col justify-end p-6 transform-gpu will-change-transform shadow-2xl"
...
<!--推荐视频-->
              ...
              <div class="relative z-20 space-y-2 pointer-events-none">
                ...
                <div class="flex items-center gap-4">
                  <p class="text-gray-500 truncate">@{{ videoFeedList[0].author?.username || '匿名' }} · ❤️ {{ videoFeedList[0].like_count }}赞</p>
                  <p class="flex items-center gap-1">
                    ...
                    <span>{{ videoFeedList[0].favorite_count || 0 }}</span>
                  </p>
                </div>
              </div>
              <span>
